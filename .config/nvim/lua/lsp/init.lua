...
vim.fn.sign_define(
  ...
  { texthl = "LspDiagnosticsSignInformation", text = "☃️", numhl = "LspDiagnosticsSignInformation" }
)
...
local servers = { 'pyright', 'gopls', 'rust_analyzer', 'tsserver', 'clangd' }
...
local sumneko_binary = "/Users/ivan/Documents/github/lua-language-server/bin/macOS/lua-language-server"
